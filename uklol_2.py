...
zadany_kod = input("Vypište kód zboží: ").upper()
...
slovo = input("Napište slovo, které byste chtěli přeložit (bez diakritiky): ").lower()
preklad = ""
morse_code[" "] = "/"

for znak in slovo:
    if znak in morse_code:
        preklad += morse_code[znak] + " "

        
print(f"Překlad {slovo} je: {preklad}")
...
tazany_region = input("Jaký region si přejete vyhledat?: ")

mesta_regionu = []

for pomocnik in staty:
    pomocnik_region = pomocnik["region"]
    pomocnik_mesta = pomocnik["capital"]
    if pomocnik_region == tazany_region:
        mesta_regionu.append(pomocnik_mesta)

if mesta_regionu:
    print(f"V hledaném regionu {tazany_region} se nachází tato hlavní města: {mesta_regionu}")
